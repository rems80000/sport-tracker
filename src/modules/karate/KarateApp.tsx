...
import { BookOpen, Dumbbell, House, NotebookPen, Library, Shield } from 'lucide-react'
...
import { UkeLibrary, UkeResourceLinks, UkeResources } from './UkeResources'
import './karate.css'
...
const menu = [
  ...
  { to: '/karate/uke', label: 'Uke', icon: Shield },
  { to: '/karate/preparation', label: 'Préparation', icon: Dumbbell },
  { to: '/karate/documentation', label: 'Ressources', icon: Library },
